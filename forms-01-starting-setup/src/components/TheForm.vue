<template>
  <form @submit.prevent="submitForm()">
    <div class="form-control" :class="{invalid : userNameValidity === 'invalid'}">
      ...
      <p v-if="userNameValidity === 'invalid'">Please Enter Valid Input</p>
    </div>
    <div class="form-control">
      <label for="age">Your Age (Years)</label>
      <input id="age" name="age" type="number"  v-model.number="userAge" ref="age" />
    </div>
    <div class="form-control">
    ...
    <div class="form-control">
      ...
      <div>
        <input id="interest-tutorials"
         name="interest" type="checkbox" value="tutorials" v-model="interest"/>
    ...
    <div>
      <input type="checkbox" id="confirm-terms" name="confirm-terms" value="confirm-terms" v-model="confirm"/>
      <label for="confirm-terms">agrre Terms</label>
    </div>
    <div>
